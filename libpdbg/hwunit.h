...
struct chipop {
	...
	int (*chipinit) (struct chipop *);
	int (*bootstrap) (struct chipop *);
	int (*get_all_code_level) (struct chipop *, uint16_t *, uint16_t *, uint32_t **, uint16_t *);
	int (*validate_n_sync)(struct chipop *, uint32_t *, uint32_t *, uint32_t **);
	int (*update_image)(struct chipop *, uint32_t *, uint32_t *, uint32_t **);
